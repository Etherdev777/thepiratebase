...
contract ThePirateBase is ERC20, Ownable {
    using SafeMath for uint256;

    mapping (address => bool) public _isWhiteListed;

    uint256 public maxWalletLimit = 55000 * 10 ** decimals();

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;

    constructor() ERC20("The Pirate Base", "$TPB") {
    ...
    function whiteListFromLimits(address account) public onlyOwner {
